/** 566. GFS Client
 *      Implement a simple client for GFS (Google File System, a distributed file system), it provides the 
 *  following methods:
 ...
 *      To simplify this question, we can assume that the chunk size is chunkSize bytes. (In a real world system, 
 *  it is 64M). The GFS Client's job is splitting a file into multiple chunks (if need) and save to the remote GFS
 *  server. chunkSize will be given in the constructor. You need to call these two private methods to implement 
 *  read& write methods.
 *
 *      Example:  GFSClient(5)
 *                read("a.txt")
 ...
 public class GFSClient extends BaseGFSClient {
    ...
    */
    ...
    public String read(String filename) {
        ...
        String chunk = readChunk(filename, chunkIndex);
        while(chunk != null){
            content.append(chunk);
            chunkIndex++;
            chunk = readChunk(filename, chunkIndex);
        }
